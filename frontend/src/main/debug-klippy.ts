...
import { KlippyDebugInfo, NestedRecord } from "../types/interfaces";
import { getLogger } from "./logger";

/**
 * Get debug information for the Llama binary
 *
 * @returns {Promise<KlippyDebugInfo>} The debug information
 */
export async function getKlippyDebugInfo(): Promise<KlippyDebugInfo> {
  const debugInfo: KlippyDebugInfo = {
