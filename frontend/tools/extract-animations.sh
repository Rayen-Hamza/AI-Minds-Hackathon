...
usage() {
    ...
    echo "  -t, --tsx FILE         Generate TSX file with animation info (default: ../src/renderer/klippy-animations.tsx)"
...
if [ "$GENERATE_TSX" = true ] && [ -z "$TSX_OUTPUT_FILE" ]; then
    ...
    TSX_OUTPUT_FILE="${SCRIPT_DIR}/../src/renderer/klippy-animations.tsx"
fi
